...
[![](https://github.com/nlowe/aoc2025/workflows/CI/badge.svg)](https://github.com/nlowe/aoc2025/actions) [![Coverage Status](https://coveralls.io/repos/github/nlowe/aoc2025/badge.svg?branch=master)](https://coveralls.io/github/nlowe/aoc2025?branch=master) [![Go Report Card](https://goreportcard.com/badge/github.com/nlowe/aoc2025)](https://goreportcard.com/report/github.com/nlowe/aoc2025) [![License](https://img.shields.io/badge/license-MIT-brightgreen)](./LICENSE)

Solutions for the 2025 Advent of Code

## Building

This project makes use of Go 1.25.
...
export your session cookie from https://adventofcode.com as `AOC_SESSION_TOKEN` in
you environment so the generator can download challenge inputs.
