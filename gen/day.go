...
func goimports(file string) {
	g := exec.Command("goimports", "-local", "github.com/nlowe/aoc2025", "-w", file)
...
func getInput(day int) ([]byte, error) {
	...
	req, err := http.NewRequest(http.MethodGet, fmt.Sprintf("https://adventofcode.com/2025/day/%d/input", day), nil)
	if err != nil {
		return nil, err
	}
